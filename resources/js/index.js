...
const getHourlyWeather = async (lat, lon) => {
	try {
		...
		for (let i = 0; i < 8; i++) {
			...
			predictImg.width = '25';
			if (description == 'Sunny') {
				predictImg.src = 'resources/svg/weather-sun.png';
				weatherBackground.style.backgroundColorcolor = '#4C87DE';
			} else if (description == 'Clouds') {
				predictImg.src = 'resources/svg/weather-cloud.png';
			} else if (description == 'Rain') {
				predictImg.src = 'resources/svg/weather-rain.png';
			} else if (description == 'Mist') {
				predictImg.src = 'resources/svg/weather-mist.png';
			}
